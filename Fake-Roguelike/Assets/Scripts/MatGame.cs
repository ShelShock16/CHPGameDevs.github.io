    ...
    void StageOne()
    {
        if (PlayerPrefs.GetInt("Progress") == 24)
        {
            ...
            if (l == 1)
            {
                ...
                "¡¿POR QUÉ SOY UN HAMSTER?!",
                "Viar dijo algo al respecto hace rato…",
                "Creo que esto es parte del escrito de matemática.",
                "Hola…",
                "¿Están listos para ser animales por el resto de sus vidas?",
                "NO.",
                "QUIERO IRME.",
                "Al entrar a este salón sellaron su destino…",
                "No pueden escapar.",
                "No.",
                "Pero podemos pasar esto.",
                "No, no podemos, pero vamos a intentar.",
                "¿Podrías ser un poquito menos negativo?",
    ...
    void StageTwo()
    {
        if (PlayerPrefs.GetInt("Progress") == 26)
        {
            ...
            if (l == 1)
            {
                ...
                {
                 "¿Vieron eso?",
                "¡Un marcador gigante acaba de volar en el medio del salón! ",
                "¡Y salen lápices del piso!",
                "¡Esto es imposible!",
                "Los profesores se van a quedar sin lápices y marcadores eventualmente.",
                "Solo tenemos que aguantar.",
                "Lo decís como si fuera fácil.",
                "Estén atentos, vamos bien.",
            };
    ...
    void StageThree()
    {
        if (PlayerPrefs.GetInt("Progress") == 28)
        {
            ...
            if (l == 1)
            {
                ...
                "¡No podemos permitir que pasen el año así!",
                "Pero… ¿No es ilegal hacer eso?",
                "Digo, privar a un estudiante de aprobar un escrito.",
                "¡La ley no importa si tengo más marcadores y lápices que ustedes!",
                };
